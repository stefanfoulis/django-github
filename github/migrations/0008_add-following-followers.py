...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding ManyToManyField 'GithubUser.following'
        db.create_table('github_user_following', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_githubuser', models.ForeignKey(orm.GithubUser, null=False)),
            ('to_githubuser', models.ForeignKey(orm.GithubUser, null=False))
        ))
        
        # Adding ManyToManyField 'GithubUser.followers'
    ...
    def backwards(self, orm):
        ...
        # Dropping ManyToManyField 'GithubUser.following'
        db.delete_table('github_user_following')
        
        # Dropping ManyToManyField 'GithubUser.followers'
    ...
    models = {
        ...
        'github.githubuser': {
            ...
            'followers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['github.GithubUser']"}),
            'followers_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'following': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['github.GithubUser']"}),
        ...
        'github.project': {
            ...
            'watchers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['github.GithubUser']", 'symmetrical': 'False'})
        }
    }
